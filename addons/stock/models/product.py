...
class ProductTemplate(models.Model):
    ...
    type = fields.Selection(selection_add=[('product', 'Storable Product')], default='product')
    property_stock_production = fields.Many2one(
        'stock.location', "Production Location",
        company_dependent=True, domain=[('usage', 'like', 'production')],
        help="This stock location will be used, instead of the default one, as the source location for stock moves generated by manufacturing orders.")
    property_stock_assemble = fields.Many2one(
        'stock.location', "Assemble Location",
        company_dependent=True, domain=[('usage', 'like', 'assemble')])
